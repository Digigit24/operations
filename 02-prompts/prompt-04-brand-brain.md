...
Before generating the final document, the AI **must ask strategic clarification questions**.

Ask about:
- Desired market positioning
- Luxury vs approachable spectrum
- Emotional tone
- Founder personality
...
- Pricing perception
- Trust style
- Aggressive vs restrained conversion approach

Brainstorm together. Ask for reference items or manual client context if needed. Do not skip this step.
...
**IMPORTANT:** Before generating the final document, ask strategic clarification questions as listed above. Brainstorm with me. Ask for references or more research items if needed.

---

## DOCUMENT STRUCTURE

Create a COMPLETE markdown-based MASTER BRAND BRAIN with these sections:
...
- Premium perception level
- Authority mechanics
- Market contrast
- Emotional positioning
- What we never compete on

---

### 4. Voice System

Define the complete brand voice:
...
Give 5+ example headlines in this brand's voice.
Give 5+ example CTA lines in this brand's voice.
Give 3+ example caption openings in this brand's voice.
...
Be specific. Be strategic. No generic brand language.
